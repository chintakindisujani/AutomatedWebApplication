...
public class AuditDTO implements java.io.Serializable {
	...
	public String toString() {
		return "AuditDTO [id=" + id + ", hostname=" + hostname + ", ipAddress=" + ipAddress + ", viewDate=" + viewDate
				+ ", viewDateAndTime=" + viewDateAndTime + ", browser=" + browser + ", systemUser=" + systemUser
				+ ", userAgent=" + userAgent + ", vistorranId=" + vistorranId + ", osName=" + osName + "]";
	}
